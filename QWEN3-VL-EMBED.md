...
**Patch:** `patches/fp8-e5m2-quant-utils.patch` (C++ `quant_utils.cuh`).
**YAML:** patch #35 in `vllm-packages.yaml`.
...
The ViT FP32 patch (`patches/qwen3vl-vit-fp32.patch`, YAML #31/#32) must
remain active regardless of quantization scheme.
...
**YAML:** patch #34 in `vllm-packages.yaml`
**Auto-applied on rebuild:** Yes
